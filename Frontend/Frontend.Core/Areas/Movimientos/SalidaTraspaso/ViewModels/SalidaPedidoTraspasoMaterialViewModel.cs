...
{
    public class SalidaPedidoTraspasoMaterialViewModel : BaseViewModel, ISalidaPedidoTraspasoMaterialViewModel
    {
        ...
        public IMaterialService MaterialService => materialService;
        ...
        public SalidaPedidoTraspasoMaterialViewModel(INavigationService navigationService, IMaterialService materialService,
                IDisplayAlertService displayAlertService,ISalidaInternaService salidaInternaService, ILecturaQRService lecturaQRService)
        {
            Title = "Material";
        ...
        {
            await StartSpinner();
            var listMateriales = await salidaInternaService.GetAllMaterialBy(EstadoMovimiento.Recibir, ClaseDeMovimientoSalidaInterna.ClaseDeMovimiento[ClaseDeMovimientoSalidaInterna.CLASE_351]);
        ...
        private async Task GoToIngresarPorMaterial()
        {
            ...
            {
                await StartSpinner();
                var salidas = await salidaInternaService.GetAllBy(await lecturaQRService.GetLecturaQR(SearchValue), ClaseDeMovimientoSalidaInterna.ClaseDeMovimiento[ClaseDeMovimientoSalidaInterna.CLASE_351]);
        ...
        private void GoToCabeceraDeSalida(SalidaInterna salidaInterna)
        {
            navigationService.PushAsync<SalidaPedidoTraspasoView, CabeceraSalidaTraspasoView>(salidaInterna);
        }
    }
}
