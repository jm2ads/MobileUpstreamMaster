...
using Frontend.Core.Areas.Movimientos.SalidasInternas.Models;
...
{
    public class ListadoPosicionesSalidaInternaViewModel : BaseViewModel, IListadoPosicionesSalidaInternaViewModel
    {
        ...
        public ListadoPosicionesSalidaInternaViewModel(INavigationService navigationService, IDisplayAlertService displayAlertService,
        ...
        {
            salidaInterna = navigationService.GetNavigationParams<ListadoPosicionesSalidaInternaView>() as SalidaInterna;
        ...
        private async void OnBackButtonPressed()
        {
            ...
            if (answer)
            {
                navigationService.PopAsync<ListadoPosicionesSalidaInternaView>();
            }
        }

        private void GoToCabecera()
        {
            navigationService.PushAsync<ListadoPosicionesSalidaInternaView, CabeceraDeSalidaInternaView>(salidaInterna);
        }
        ...
        private bool HasContados()
        {
            return salidaInternaService.HasContados(salidaInterna);
        }
        ...
        private void GoToDetalle(ListadoPosicionesSalidaInternaModel listadoPosicionesSalidaInternaModel)
        {
            ...
            {
                navigationService.PushAsync<ListadoPosicionesSalidaInternaView, DetalleMaterialSalidaInternaView>(listadoPosicionesSalidaInternaModel.detalleSalidaInterna);
            }
        }
    }
}
