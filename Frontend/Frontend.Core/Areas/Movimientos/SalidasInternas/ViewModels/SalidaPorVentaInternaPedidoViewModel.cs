...
{
    public class SalidaPorVentaInternaPedidoViewModel : BaseViewModel, ISalidaPorVentaInternaPedidoViewModel
    {
        ...
        public SalidaPorVentaInternaPedidoViewModel(INavigationService navigationService, ISalidaInternaService salidaInternaService, SalidaInternaFactory salidaInternaFactory)
        {
            Title = "Pedido";
        ...
        private async Task GetAllSalidas()
        {
            try
            {
                ListSalidas = await salidaInternaService.GetAllBy(EstadoMovimiento.Recibir, ClaseDeMovimientoSalidaInterna.ClaseDeMovimiento[ClaseDeMovimientoSalidaInterna.CLASE_643]);
        ...
        private async Task GoToCabeceraDeSalidaInterna()
        {
            try
            {
                ...
                navigationService.PushAsync<SalidaPorVentaInternaView, CabeceraDeSalidaInternaView>(salida);
            }
