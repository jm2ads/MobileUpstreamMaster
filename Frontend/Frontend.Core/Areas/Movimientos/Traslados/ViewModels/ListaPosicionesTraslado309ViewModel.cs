...
{
    public class ListaPosicionesTraslado309ViewModel : BaseViewModel, IListaPosicionesTraslado309ViewModel
    {
        ...
        public ListaPosicionesTraslado309ViewModel(INavigationService navigationService, IDisplayAlertService displayAlertService,
        ...
        {
            traslado = navigationService.GetNavigationParams<ListaPosicionesTraslado309View>() as Traslado;
        ...
        private async void OnBackButtonPressed()
        {
            ...
            if (answer)
            {
                navigationService.PopAsync<ListaPosicionesTraslado309View>();
            }
        }
        ...
        {
            navigationService.PushAsync<ListaPosicionesTraslado309View, Traslado309PorMaterialView>(traslado);
        }

        private void GoToCabecera()
        {
            navigationService.PushAsync<ListaPosicionesTraslado309View, VisualizarCabeceraTrasladoView>(traslado);
        }
        ...
        private void GoToDetalle(DetalleTraslado detalleTraslado)
        {
            ...
            {
                navigationService.PushAsync<ListaPosicionesTraslado309View, DetalleMaterialTraslado309View>(detalleTraslado);
            }
        }
    }
}
