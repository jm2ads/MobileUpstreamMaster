...
{
    public class Traslado311PorMaterialViewModel : BaseViewModel, ITraslado311PorMaterialViewModel
    {
        ...
        public Traslado311PorMaterialViewModel(INavigationService navigationService, IDisplayAlertService displayAlertService, IStockService stockService,
        ...
        private async void Init()
        {
            ...
            traslado = navigationService.GetNavigationParams<Traslado311PorMaterialView>() as Traslado;
        ...
        {
            navigationService.PushFromAsync<HomeView, ListaPosicionesTraslado311View>(traslado);
        }
    }
}
