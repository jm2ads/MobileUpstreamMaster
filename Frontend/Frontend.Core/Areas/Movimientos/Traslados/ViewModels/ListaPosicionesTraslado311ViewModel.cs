...
{
    public class ListaPosicionesTraslado311ViewModel : BaseViewModel, IListaPosicionesTraslado311ViewModel
    {
        ...
        public ListaPosicionesTraslado311ViewModel(INavigationService navigationService, IDisplayAlertService displayAlertService,
        ...
        {
            traslado = navigationService.GetNavigationParams<ListaPosicionesTraslado311View>() as Traslado;
        ...
        private async void OnBackButtonPressed()
        {
            ...
            if (answer)
            {
                navigationService.PopAsync<ListaPosicionesTraslado311View>();
            }
        }
        ...
        {
            navigationService.PushAsync<ListaPosicionesTraslado311View, Traslado311PorMaterialView>(traslado);
        }

        private void GoToCabecera()
        {
            navigationService.PushAsync<ListaPosicionesTraslado311View, VisualizarCabeceraTrasladoView>(traslado);
        }
        ...
        private void GoToDetalle(DetalleTraslado detalleTraslado)
        {
            ...
            {
                navigationService.PushAsync<ListaPosicionesTraslado311View, DetalleMaterialTraslado311View>(detalleTraslado);
            }
        }
    }
}