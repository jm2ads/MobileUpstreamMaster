...
{
    public class DetalleMaterialTraslado541ViewModel : BaseViewModel, IDetalleMaterialTraslado541ViewModel
    {
        ...
        public DetalleMaterialTraslado541ViewModel(INavigationService navigationService, ITrasladoService trasladoService, IAlmacenService almacenService,
        ...
        private void Init()
        {
            ...
            detalleTraslado = navigationService.GetNavigationParams<DetalleMaterialTraslado541View>() as DetalleTraslado;
        ...
        private async Task CompleteDetalleTraslado()
        {
            ...
            detalleTraslado.ElementoPEP = elementoPEP.Value;
            detalleTraslado.Proveedor = proveedor.Value.ToUpper();
