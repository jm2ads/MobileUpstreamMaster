...
{
    public class ListaPosicionesTraslado541ViewModel : BaseViewModel, IListaPosicionesTraslado541ViewModel
    {
        ...
        public ListaPosicionesTraslado541ViewModel(INavigationService navigationService, IDisplayAlertService displayAlertService,
        ...
        {
            traslado = navigationService.GetNavigationParams<ListaPosicionesTraslado541View>() as Traslado;
        ...
        private async void OnBackButtonPressed()
        {
            ...
            if (answer)
            {
                navigationService.PopAsync<ListaPosicionesTraslado541View>();
            }
        }
        ...
        {
            navigationService.PushAsync<ListaPosicionesTraslado541View, Traslado541PorMaterialView>(traslado);
        }

        private void GoToCabecera()
        {
            navigationService.PushAsync<ListaPosicionesTraslado541View, VisualizarCabeceraTrasladoView>(traslado);
        }
        ...
        private void GoToDetalle(DetalleTraslado detalleTraslado)
        {
            ...
            {
                navigationService.PushAsync<ListaPosicionesTraslado541View, DetalleMaterialTraslado541View>(detalleTraslado);
            }
        }
    }
}
