...
{
    public class DetalleMaterialTraslado311ViewModel : BaseViewModel, IDetalleMaterialTraslado311ViewModel
    {
        ...
        public DetalleMaterialTraslado311ViewModel(INavigationService navigationService, ITrasladoService trasladoService, IAlmacenService almacenService,
        ...
        private void Init()
        {
            ...
            detalleTraslado = navigationService.GetNavigationParams<DetalleMaterialTraslado311View>() as DetalleTraslado;
