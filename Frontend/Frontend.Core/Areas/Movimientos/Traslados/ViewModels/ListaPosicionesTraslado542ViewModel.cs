...
{
    public class ListaPosicionesTraslado542ViewModel : BaseViewModel, IListaPosicionesTraslado542ViewModel
    {
        ...
        public ListaPosicionesTraslado542ViewModel(INavigationService navigationService, IDisplayAlertService displayAlertService,
        ...
        {
            traslado = navigationService.GetNavigationParams<ListaPosicionesTraslado542View>() as Traslado;
        ...
        private async void OnBackButtonPressed()
        {
            ...
            if (answer)
            {
                navigationService.PopAsync<ListaPosicionesTraslado542View>();
            }
        }
        ...
        {
            navigationService.PushAsync<ListaPosicionesTraslado542View, Traslado542PorMaterialView>(traslado);
        }

        private void GoToCabecera()
        {
            navigationService.PushAsync<ListaPosicionesTraslado542View, VisualizarCabeceraTrasladoView>(traslado);
        }
        ...
        private void GoToDetalle(DetalleTraslado detalleTraslado)
        {
            ...
            {
                navigationService.PushAsync<ListaPosicionesTraslado542View, DetalleMaterialTraslado542View>(detalleTraslado);
            }
        }
    }
}
