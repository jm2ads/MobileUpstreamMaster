...
{
    public class VisualizarCabeceraDevolucionViewModel : BaseViewModel, IVisualizarCabeceraDevolucionViewModel
    {
        ...
        public VisualizarCabeceraDevolucionViewModel(INavigationService navigationService, ISettingsService settingsService)
        {
        ...
        {
            notaDeReserva = navigationService.GetNavigationParams<VisualizarCabeceraDevolucionView>() as NotaDeReserva;
