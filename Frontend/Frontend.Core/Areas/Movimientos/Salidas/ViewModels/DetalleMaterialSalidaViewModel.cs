...
{
    public class DetalleMaterialSalidaViewModel : BaseViewModel, IDetalleMaterialSalidaViewModel
    {
        ...
        public DetalleMaterialSalidaViewModel(INavigationService navigationService, IReservaService reservaService, IAlmacenService almacenService,
        ...
        private async void Init()
        {
            ...
            detalleNotaDeReserva = navigationService.GetNavigationParams<DetalleMaterialSalidaView>() as DetalleNotaDeReserva;
        ...
        private async void ConfirmarMaterial()
        {
            ...
            navigationService.PushFromAsync<CabeceraSalidaView, DetalleSalidaView>(notaDeReserva);
        }
